...
public class Perpustakaan {
    ...
    // mengubah status sebuah buku
    public void kembalikanBuku (String judul){
        for (Buku b : koleksi) {
            if(b.getJudul().equals(judul)){
                b.setDipinjam(false);
                System.out.println("Buku " + b.getJudul() + " Telah dikembalikan");
            }
        }
    }
    ...
    public void cariPenulis(String penulis){
        ...
        System.out.println("Berikut buku karangan " + penulis);
        for (Buku b : koleksi) {
            if (b.getPenulis().equals(penulis)){
                urutanbuku ++;
                System.out.println(urutanbuku + ". " + b.getJudul() + " " + b.getTahunTerbit());
            }
        }
        if (urutanbuku == 0){
            System.out.println("Tidak ada buku karangan " + penulis);
        }
    }
